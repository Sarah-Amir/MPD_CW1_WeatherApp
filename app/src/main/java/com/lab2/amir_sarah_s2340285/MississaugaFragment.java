 ...
 */
public class MississaugaFragment extends Fragment implements OnMapReadyCallback {
    ...
    private String url1 = "";
    private String urlSource = "https://weather-broker-cdn.api.bbci.co.uk/en/forecast/rss/3day/6075357"; // 3-day Forecast
    private String urlSource1 = "https://weather-broker-cdn.api.bbci.co.uk/en/observation/rss/6075357"; //Current Forecast
    private String location="Mississauga";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_mississauga, container, false);
    ...
    public void startProgress() {
        ...
        // Approach 1:
        Thread thread1 = new Thread(new MississaugaFragment.Task(urlSource));
        Thread thread2 = new Thread(new MississaugaFragment.Task(urlSource1));
