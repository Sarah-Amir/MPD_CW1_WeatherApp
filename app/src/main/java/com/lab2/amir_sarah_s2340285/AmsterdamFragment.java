...
public class AmsterdamFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_amsterdam, container, false);
    ...
    public void startProgress() {
        ...
        // Approach 1:
        Thread thread1 = new Thread(new AmsterdamFragment.Task(urlSource));
        Thread thread2 = new Thread(new AmsterdamFragment.Task(urlSource1));
