 ...
 */
public class NewyorkFragment extends Fragment implements OnMapReadyCallback {
    private TextView rssFeed;
    private TextView listDataDisplay;
    private String result;
    private String url1 = "";
    private String urlSource = "https://weather-broker-cdn.api.bbci.co.uk/en/forecast/rss/3day/5128581"; // 3-day Forecast
    private String urlSource1 = "https://weather-broker-cdn.api.bbci.co.uk/en/observation/rss/5128581"; //Current Forecast
    ...
    public void startProgress() {
        ...
        // Approach 1:
        Thread thread1 = new Thread(new NewyorkFragment.Task(urlSource));
        Thread thread2 = new Thread(new NewyorkFragment.Task(urlSource1));
